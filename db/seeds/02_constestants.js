  ...
  await knex("contestants").insert([
    {
      ...
      url_photo:
        "https://monologue-avatars.s3.us-east-2.amazonaws.com/istockphoto-501787000-2048x2048.jpg",
    ...
    },
    {
      ...
      name: "Kevin Rogers",
      description:
        "I used to be a sports athlete until my injury. Now I want to act.",
      url_photo:
        "https://monologue-avatars.s3.us-east-2.amazonaws.com/istockphoto-504123304-2048x2048.jpg", // S3 URL
    ...
    },
    {
      ...
      url_photo:
        "https://monologue-avatars.s3.us-east-2.amazonaws.com/istockphoto-811177514-2048x2048.jpg", // S3 URL
    ...
    },
    {
      ...
      name: "Angelo Markus",
      description:
        "I am an engineer, but I do love to perform. Please vote for me.",
      url_photo:
        "https://monologue-avatars.s3.us-east-2.amazonaws.com/istockphoto-858449444-2048x2048.jpg", // S3 URL
    ...
    },
    {
      ...
      url_photo:
        "https://monologue-avatars.s3.us-east-2.amazonaws.com/istockphoto-1218999241-2048x2048.jpg", // S3 URL
      url_video: "https://www.youtube.com/watch?v=pGKGFGKC_bA",
    ...
    },
    {
      ...
      description: "I love theatre. I have a backround in broadway.",
      url_photo:
        "https://images.squarespace-cdn.com/content/v1/5ef253fe0814c166c3d8b4a5/4abb0a2c-2fd7-4fa8-ad16-792f329249cd/Miranda_Low+Res-9.jpg?format=500w",
      url_video: "https://www.youtube.com/watch?v=0yZcDeVsj_Y",
    ...
    },
    {
      ...
      description:
        "I used to be a sports athlete until my injury. Now I want to act.",
      url_photo:
        "https://images.squarespace-cdn.com/content/v1/5ef253fe0814c166c3d8b4a5/8ca61b60-3111-498a-95ce-20f745e8dab3/Poppy+and+Finch_Low+Res-32.jpg?format=500w",
      url_video: "https://www.youtube.com/watch?v=HMxbdAEUqfk",
    ...
    },
    {
      ...
      description: "Hoping to make my dad proud.",
      url_photo:
        "https://images.squarespace-cdn.com/content/v1/5ef253fe0814c166c3d8b4a5/e312bac2-54cf-4ad7-90bb-026124394725/Lily_Low+Res-8.jpg?format=500w",
      url_video: "https://www.youtube.com/watch?v=pGKGFGKC_bA",
    ...
    },
    {
      ...
      description:
        "I am an engineer, but I do love to perform. Please vote for me.",
      url_photo:
        "https://images.squarespace-cdn.com/content/v1/5ef253fe0814c166c3d8b4a5/39b565a6-197c-4e06-96c8-44b094e27315/Wilder_Low+Res-9.jpg?format=500w",
      url_video: "https://www.youtube.com/watch?v=-1tLkSJNK0M",
    ...
    },
    {
      ...
      description: "Trying to stay active and young. Why not do this? yay! ",
      url_photo:
        "https://images.squarespace-cdn.com/content/v1/5ef253fe0814c166c3d8b4a5/43c92e64-73ca-46c8-9b98-1638987e6819/Spring+2022_Low+Res-122.jpg?format=500w",
      url_video: "https://www.youtube.com/watch?v=pGKGFGKC_bA",
